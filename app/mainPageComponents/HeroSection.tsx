...
function HeroSection() {
  return (
    <div className='flex flex-col mx-16 items-center mt-[100px] gap-6'>
        ...
        <button className={`block text-sm font-light rounded-lg px-9 py-3 text-white transition bg-customRed focus:outline-none`} type='button'>{`Let's get started`}</button>
    </div>
  )
}
